...
public:
    ...
    std::string getShortName () const { return d_shortName; }
    std::string getLongName () const { return d_longName; }
    bool hasName (const std::string & name) const { 
        return (d_shortName.compare (name) == 0 || d_longName.compare (name) == 0); 
    }
    bool isSet () const { return d_isSet; }
    virtual void setValue (const std::string & value) { std::cout << "WHAT!" << std::endl; };
    virtual void setValue (const int value) { };
    virtual void setValue (const double value) { };
    virtual void setValue (const bool value) { };
    virtual int getIValue () const { return 0; };
    virtual bool getBValue () const { return false; };
    virtual std::string getSValue () const { return ""; };
    virtual double getFValue () const { return 0.0f; };
...
private:
    ...
    static const int d_DESCRIBE_WIDTH = 2;
    static const int d_MAX_LINE_WIDTH = 80;
    static const int d_MAX_LONG_PARA_WIDTH = 32;
    static const int d_SPACES_WIDTH = 41;
